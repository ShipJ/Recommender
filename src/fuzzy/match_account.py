...
def fuzzy_account(debug, dfl, dfr):
    ...
    for idx, row in dfl.iterrows():
        ...
        if not name_matches.empty:
            ...
            status_i.update_id_action(name_matches[name_matches.AddressStrip == match[0]]['Id'].loc[0], 'Verify')
        ...
        # Exact Name Match Not Found, Search for Exact Address Match
            ...
            if not address_matches.empty:
                ...
                if not trigram_matches.empty:
                    trigram_matches['NameAddress'] = trigram_matches['NameStrip'] + ' ' + trigram_matches['AddressStrip']
        ...
        matching_records.append([row.Id, status_i.id_best
                                ...
                                , row.AddressStrip, status_i.address_best, status_i.address_status, status_i.address_prob])
